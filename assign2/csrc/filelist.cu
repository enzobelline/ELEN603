...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _18470_archive_1.so
_18470_archive_1.so : archive.86/_18470_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_18470_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_18470_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.86/_prev_archive_1.a
	@$(AR) -s $<
