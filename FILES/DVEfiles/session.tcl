...
# DVE full session
# Saved on Sun Dec 18 03:14:43 2022
# Designs open: 1
...
#   Source.1: tb.dut
#   Group count = 8
#   Group inst[0].fifo signal count = 18
#   Group inst[0].portout signal count = 18
#   Group inst[0].mux8x1 signal count = 16
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{583 77} {1918 1050}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 195} {height 682} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 244} {height 682} {dock_state left} {dock_on_new_line true} {child_data_colvariable 189} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 174]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1336
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 174
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1335} {height 173} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_81 {inst[0].fifo}
gui_sg_create "$_session_group_81"
set {inst[0].fifo} "$_session_group_81"

gui_sg_addsignal -group "$_session_group_81" { {tb.dut.inst[0].fifo.Wait} {tb.dut.inst[0].fifo.head} {tb.dut.inst[0].fifo.PopReady} {tb.dut.inst[0].fifo.data_out} {tb.dut.inst[0].fifo.i} {tb.dut.inst[0].fifo.clk_pop} {tb.dut.inst[0].fifo.data_in} {tb.dut.inst[0].fifo.popState} {tb.dut.inst[0].fifo.clk_push} {tb.dut.inst[0].fifo.reset_n} {tb.dut.inst[0].fifo.tail} {tb.dut.inst[0].fifo.push_req_n} {tb.dut.inst[0].fifo.clear} {tb.dut.inst[0].fifo.stack[1]} {tb.dut.inst[0].fifo.stack[0]} {tb.dut.inst[0].fifo.stack} {tb.dut.inst[0].fifo.pop_req_n} {tb.dut.inst[0].fifo.$unit} }
...
set _session_group_82 {inst[0].portout}
gui_sg_create "$_session_group_82"
set {inst[0].portout} "$_session_group_82"

gui_sg_addsignal -group "$_session_group_82" { {tb.dut.inst[0].portout.clock} {tb.dut.inst[0].portout.vld} {tb.dut.inst[0].portout.reset_n} {tb.dut.inst[0].portout.din} {tb.dut.inst[0].portout.dout} {tb.dut.inst[0].portout.frameo_n} {tb.dut.inst[0].portout.valido_n} {tb.dut.inst[0].portout.pop} {tb.dut.inst[0].portout.cntp} {tb.dut.inst[0].portout.cnta} {tb.dut.inst[0].portout.payload} {tb.dut.inst[0].portout.current_state} {tb.dut.inst[0].portout.Wait} {tb.dut.inst[0].portout.validState} {tb.dut.inst[0].portout.payloadState} {tb.dut.inst[0].portout.addr} {tb.dut.inst[0].portout.writeout} {tb.dut.inst[0].portout.$unit} }
...
set _session_group_83 {inst[0].mux8x1}
gui_sg_create "$_session_group_83"
set {inst[0].mux8x1} "$_session_group_83"

gui_sg_addsignal -group "$_session_group_83" { {tb.dut.inst[0].mux8x1.vld_from_input} {tb.dut.inst[0].mux8x1.clock} {tb.dut.inst[0].mux8x1.reset_n} {tb.dut.inst[0].mux8x1.clr} {tb.dut.inst[0].mux8x1.x} {tb.dut.inst[0].mux8x1.valid_from_mux} {tb.dut.inst[0].mux8x1.datout} {tb.dut.inst[0].mux8x1.addr_from_input} {tb.dut.inst[0].mux8x1.addr_from_input[0]} {tb.dut.inst[0].mux8x1.datain[0]} {tb.dut.inst[0].mux8x1.datain} {tb.dut.inst[0].mux8x1.i} {tb.dut.inst[0].mux8x1.current_state} {tb.dut.inst[0].mux8x1.readenable} {tb.dut.inst[0].mux8x1.validState} {tb.dut.inst[0].mux8x1.$unit} }
...
set _session_group_84 {inst[0].port}
gui_sg_create "$_session_group_84"
set {inst[0].port} "$_session_group_84"

gui_sg_addsignal -group "$_session_group_84" { {tb.dut.inst[0].port.clock} {tb.dut.inst[0].port.reset_n} {tb.dut.inst[0].port.frame_n} {tb.dut.inst[0].port.valid_n} {tb.dut.inst[0].port.di} {tb.dut.inst[0].port.clr} {tb.dut.inst[0].port.payload} {tb.dut.inst[0].port.addr} {tb.dut.inst[0].port.vld} {tb.dut.inst[0].port.cnta} {tb.dut.inst[0].port.cntp} {tb.dut.inst[0].port.$unit} }

set _session_group_85 {inst[1].fifo}
gui_sg_create "$_session_group_85"
set {inst[1].fifo} "$_session_group_85"

gui_sg_addsignal -group "$_session_group_85" { {tb.dut.inst[1].fifo.clk_push} {tb.dut.inst[1].fifo.clk_pop} {tb.dut.inst[1].fifo.reset_n} {tb.dut.inst[1].fifo.push_req_n} {tb.dut.inst[1].fifo.pop_req_n} {tb.dut.inst[1].fifo.data_in} {tb.dut.inst[1].fifo.clear} {tb.dut.inst[1].fifo.data_out} {tb.dut.inst[1].fifo.head} {tb.dut.inst[1].fifo.tail} {tb.dut.inst[1].fifo.i} {tb.dut.inst[1].fifo.popState} {tb.dut.inst[1].fifo.stack} {tb.dut.inst[1].fifo.PopReady} {tb.dut.inst[1].fifo.Wait} {tb.dut.inst[1].fifo.$unit} }
...
set _session_group_86 {inst[1].mux8x1}
gui_sg_create "$_session_group_86"
set {inst[1].mux8x1} "$_session_group_86"

gui_sg_addsignal -group "$_session_group_86" { {tb.dut.inst[1].mux8x1.vld_from_input} {tb.dut.inst[1].mux8x1.clock} {tb.dut.inst[1].mux8x1.reset_n} {tb.dut.inst[1].mux8x1.clr} {tb.dut.inst[1].mux8x1.x} {tb.dut.inst[1].mux8x1.valid_from_mux} {tb.dut.inst[1].mux8x1.datout} {tb.dut.inst[1].mux8x1.addr_from_input} {tb.dut.inst[1].mux8x1.datain} {tb.dut.inst[1].mux8x1.i} {tb.dut.inst[1].mux8x1.current_state} {tb.dut.inst[1].mux8x1.readenable} {tb.dut.inst[1].mux8x1.validState} {tb.dut.inst[1].mux8x1.$unit} }
...
set _session_group_87 {inst[1].port}
gui_sg_create "$_session_group_87"
set {inst[1].port} "$_session_group_87"

gui_sg_addsignal -group "$_session_group_87" { {tb.dut.inst[1].port.clock} {tb.dut.inst[1].port.reset_n} {tb.dut.inst[1].port.frame_n} {tb.dut.inst[1].port.valid_n} {tb.dut.inst[1].port.di} {tb.dut.inst[1].port.clr} {tb.dut.inst[1].port.payload} {tb.dut.inst[1].port.addr} {tb.dut.inst[1].port.vld} {tb.dut.inst[1].port.cnta} {tb.dut.inst[1].port.cntp} {tb.dut.inst[1].port.$unit} }

set _session_group_88 {inst[1].portout}
gui_sg_create "$_session_group_88"
set {inst[1].portout} "$_session_group_88"

gui_sg_addsignal -group "$_session_group_88" { {tb.dut.inst[1].portout.Wait} {tb.dut.inst[1].portout.vld} {tb.dut.inst[1].portout.dout} {tb.dut.inst[1].portout.din} {tb.dut.inst[1].portout.clock} {tb.dut.inst[1].portout.cntp} {tb.dut.inst[1].portout.pop} {tb.dut.inst[1].portout.frameo_n} {tb.dut.inst[1].portout.payloadState} {tb.dut.inst[1].portout.addr} {tb.dut.inst[1].portout.reset_n} {tb.dut.inst[1].portout.valido_n} {tb.dut.inst[1].portout.validState} {tb.dut.inst[1].portout.payload} {tb.dut.inst[1].portout.$unit} {tb.dut.inst[1].portout.current_state} {tb.dut.inst[1].portout.writeout} {tb.dut.inst[1].portout.cnta} }
